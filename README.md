...
$ npm start
### how to start mongo
1. In first terminal window, navigate to backend folder and Run '$ mongod'
2. In second terminal window, navigate to backend folder and run '$ mongo'
3. Then run '> use sfadb'
4. The run 'db.groups.insert({"group_name" : "JMC LLC"})'
